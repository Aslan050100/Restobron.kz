...
@section('content')
    @include('users.partials.header', ['title' => __('Добавить отзыв')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Управление отзывом') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('feedback.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-alternative" type="textarea" name="comment" placeholder="Введите текст здесь ...">
                                </div>
