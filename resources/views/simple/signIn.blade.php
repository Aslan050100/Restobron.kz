...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/sign_in.css') }}" type="text/css" />
...
<div class="sign_in">
    <div class="centering">
        ...
        <form class="" action="{{route('simple.login')}}" method="post">
            {{ csrf_field() }}
        ...
        <p class="bottom_paragraph">Forgot Password?<br>
            Not registered? <a href="{{route('simple.signUp')}}">Click to register</a></p>
    </div>
